...
TR
  ...
  Kullanım:
    - python gnucrypt.py -e 'şifrelemek için' ya da -d 'deşifrelemek için' [dosya_yolu] -p [şifre]
...
ENG
   ...
   Usage:
     - python gnucrypt.py -e 'for encryption' or -d 'for decryption' [file_destination] -p [password]
